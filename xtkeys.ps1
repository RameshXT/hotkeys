...
.PARAMETER Command
    The action command to execute: 'status', 'update', 'restart', 'uninstall', 'install', 'help', 'default'.
...
param(
    ...
    [ValidateSet('status', 'update', 'restart', 'uninstall', 'install', 'help', 'doctor', 'default')]
...
function Invoke-Help {
    Write-Host ""
    Write-UI "xtkeys command-line management tool" "INFO"
    Write-Host ""
